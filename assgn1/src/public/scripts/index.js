...
function getUserDisplayEle(user) {
    return `<div class="user-display-ele">
        ...
        <div class="edit-view">
            <div>
                Nama: <input class="name-edit-input" value="${user.nama}">
            </div>
            <div>
                Nomor KTP: <input class="email-edit-input" value="${user.noKTP}">
            </div>
...
function addUser() {
    ...
    var noKTPInput = document.getElementById('email-input');
    var data = {
        user: {
            nama: nameInput.value,
            noKTP: noKTPInput.value
        },
    };
...
function submitEdit(ele) {
    ...
    var noKTPInput = userEle.getElementsByClassName('email-edit-input')[0];
